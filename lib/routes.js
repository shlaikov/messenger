...
module.exports = function (logger, app, io) {
    ...
    var chat = io.on('connection', function (socket) {
        ...
        socket.on('load', function (data) {
            ...
            logger.debug('Data on connection: ' + data);            
            logger.debug('Room on connection: ' + room);
        ...
        socket.on('login', function (data) {
            ...
            logger.debug('Data on login: ' + data.id);            
            logger.debug('Room on login: ' + room);            
...
function findClientsSocket(io, roomId) {
    ...
    if (nsps) {
        for (var id in nsps.connected) {
            if (roomId) {
                var index = nsps.connected[id].rooms.indexOf(roomId);
